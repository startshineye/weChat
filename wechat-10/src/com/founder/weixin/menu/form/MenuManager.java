...
public class MenuManager {
	...
	private static Menu getMenu() {
       //构造二级click菜单
		...
		btn13.setName("用户授权查看用户信息");
		btn13.setType("view");
		//访问的是m站点
		btn13.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx73d9bb98d3a0175f&redirect_uri=http%3A%2F%2Ff8f6d81e.ngrok.io%2Fwxkf%2FcoreServlet&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
		
		ViewButton btn14 = new ViewButton();
		btn14.setName("您的地理位置");
		btn14.setType("view");
		//访问的是m站点
		btn13.setUrl("http://f8f6d81e.ngrok.io/wxkf/coreServlet/location.jsp");
